...
public class Draw1 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        primaryStage.setOnHiding(event -> {savePointsToFile(System.getProperty("user.dir")+"/src/function.txt");});
        ...
        Line Xaxis = new Line(0, WIDTH/2, HEIGHT, WIDTH/2); //create x axis
        Line Yaxis = new Line(HEIGHT/2, 0, HEIGHT/2, WIDTH); //create y axis
